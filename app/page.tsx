  ...
  return (
    <main className="flex flex-col items-center justify-center">
      ...
      <section className="relative flex  h-screen w-full  flex-col items-center !overflow-visible rounded-md bg-neutral-950  antialiased">
        ...
        <div className="mt-[-200px] flex flex-col md:mt-[-50px]">
          <ContainerScroll
            titleComponent={
      ...
      <section className="mt-[-500px]">
        ...
        <div className="-mt-72 flex flex-col flex-wrap items-center justify-center gap-8 md:flex-row">
          <CardContainer className="inter-var">
            <CardBody className="group/card relative h-auto  w-3/4 rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] md:!w-[350px]">
              <CardItem
                translateZ="50"
          ...
          <CardContainer className="inter-var ">
            <CardBody className="group/card relative h-auto  w-3/4 rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-[#E2CBFF] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] md:!w-[350px]">
              <CardItem
                translateZ="50"
                className="text-xl font-bold text-neutral-600 dark:text-white "
              >
